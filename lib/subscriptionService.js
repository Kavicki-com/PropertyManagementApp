...
export async function checkSubscriptionStatus(userId) {
  ...
  if (plan === 'basic' || plan === 'premium') {
    ...
    // Se o status está explicitamente como 'cancelled' ou 'expired', considera inativo
    if (subscription.subscription_status === 'cancelled' || subscription.subscription_status === 'expired') {
